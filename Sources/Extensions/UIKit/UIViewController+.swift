...
public extension UIViewController {
    ...
    func sk_addChildViewController(_ child: UIViewController, to containerView: UIView) {
        self.addChild(child)
...
public extension UIViewController {
    ...
    func sk_present(viewController: UIViewController, fullScreen: Bool = true, animated: Bool = true, completion: (() -> Void)? = nil) {
        if fullScreen {
    ...
    func sk_push(viewController: UIViewController, animated: Bool = true) {
        navigationController?.pushViewController(viewController, animated: animated)
    }

    func sk_popLast(thenPush viewController: UIViewController, animated: Bool = true) {
    ...
    func sk_pop(count: Int, thenPush viewController: UIViewController, animated: Bool = true) {
        guard let navigationController else { return }
        if count < 1 { return }
    ...
    func sk_previousViewController() -> UIViewController? {
...
public extension UIViewController {
    ...
    func sk_pop2rootViewController(_ animated: Bool = true) {
        self.navigationController?.popToRootViewController(animated: animated)
    }

    func sk_popViewController(_ animated: Bool = true) {
        self.navigationController?.popViewController(animated: animated)
    }

    func sk_pop2(_ viewController: UIViewController, animated: Bool = true) {
        self.navigationController?.popToViewController(viewController, animated: animated)
    }

    @discardableResult
    func sk_pop2(aClass: AnyClass, animated: Bool = false) -> Bool {
    ...
    func sk_pop(count: Int, animated: Bool = false) {
        guard let navigationController else { return }
    ...
    func sk_dismissViewController(_ animated: Bool = true, completion: (() -> Void)? = nil) {
        self.dismiss(animated: animated, completion: completion)
    }

    func sk_closeViewController(_ animated: Bool = true) {
...
public extension UIViewController {
    ...
    class func sk_instantiateViewController(from storyboard: String = "Main", bundle: Bundle? = nil, identifier: String? = nil) -> Self {
...
@objc extension UIViewController {
    ...
    override public class func sk_initializeMethod() {
        super.sk_initializeMethod()
        ...
        if self == UIViewController.self {
            ...
            DispatchQueue.sk_once(token: onceToken) {
                ...
                let repSel = #selector(UINavigationController.sk_hook_pushViewController(_:animated:))
                _ = self.sk_hookInstanceMethod(of: oriSel, with: repSel)
            }
        }
    }

    private func sk_hook_viewDidLoad(animated: Bool) {
        self.sk_hook_viewDidLoad(animated: animated)
    }

    private func sk_hook_viewWillAppear(animated: Bool) {
        self.sk_hook_viewWillAppear(animated: animated)
    }

    private func sk_hook_viewWillDisappear(animated: Bool) {
        self.sk_hook_viewWillDisappear(animated: animated)
    }

    private func sk_hook_present(_ viewControllerToPresent: UIViewController, animated flag: Bool, completion: (() -> Void)? = nil) {
        ...
        sk_hook_present(viewControllerToPresent, animated: flag, completion: completion)
    }
}

@objc public extension UINavigationController {

    func sk_hook_pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        self.sk_hook_pushViewController(viewController, animated: animated)
    }
}
...
public extension UIViewController {
    ...
    @discardableResult
    func sk_overrideUserInterfaceStyle(_ userInterfaceStyle: UIUserInterfaceStyle) -> Self {
    ...
    @discardableResult
    func sk_backgroundColor(_ backgroundColor: UIColor) -> Self {
        self.view.backgroundColor = backgroundColor
        return self
    }

    @discardableResult
    func sk_automaticallyAdjustsScrollViewInsets(_ automaticallyAdjustsScrollViewInsets: Bool) -> Self {
    ...
    @discardableResult
    func sk_modalPresentationStyle(_ style: UIModalPresentationStyle) -> Self {
