...
public extension CALayer {
    ...
    func sk_image(scale: CGFloat = 0.0) -> UIImage? {
...
public extension CALayer {
    func sk_basicAnimationMovePoint(_ point: CGPoint,
    ...
    func sk_basicAnimationMoveX(_ moveValue: Any?,
    ...
    func sk_basicAnimationMoveY(_ moveValue: Any?,
                                duration: TimeInterval = 2.0,
                                delay: TimeInterval = 0,
                                repeatCount: Float = 1,
                                removedOnCompletion: Bool = false,
    ...
    func sk_animationCornerRadius(_ cornerRadius: Any?,
                                  duration: TimeInterval = 2.0,
                                  delay: TimeInterval = 0,
                                  repeatCount: Float = 1,
                                  removedOnCompletion: Bool = false,
    ...
    func sk_animationScale(_ scaleValue: Any?,
                           duration: TimeInterval = 2.0,
                           delay: TimeInterval = 0,
                           repeatCount: Float = 1,
    ...
    func sk_animationRotation(_ rotation: Any?,
                              duration: TimeInterval = 2.0,
                              delay: TimeInterval = 0,
                              repeatCount: Float = 1,
                              removedOnCompletion: Bool = true,
    ...
    func sk_baseBasicAnimation(keyPath: String,
                               startValue: Any?,
                               endValue: Any?,
                               duration: TimeInterval = 2.0,
                               delay: TimeInterval = 0,
...
public extension CALayer {
    func sk_addKeyframeAnimationPosition(_ values: [Any],
                                         keyTimes: [NSNumber]?,
                                         duration: TimeInterval = 2.0,
                                         delay: TimeInterval = 0,
                                         repeatCount: Float = 1,
    ...
    func sk_addKeyframeAnimationRotation(_ values: [Any] = [
        -5.sk_cgFloat().sk_radians(),
        5.sk_cgFloat().sk_radians(),
        -5.sk_cgFloat().sk_radians(),
    ],
    keyTimes: [NSNumber]?,
    ...
    func sk_addKeyframeAnimationPositionBezierPath(_ path: CGPath? = nil,
                                                   duration: TimeInterval = 2.0,
                                                   delay: TimeInterval = 0,
                                                   repeatCount: Float = 1,
                                                   removedOnCompletion: Bool = false,
    ...
    func sk_baseKeyframeAnimation(keyPath: String,
                                  values: [Any]? = nil,
...
public extension CALayer {
    func sk_addSpringAnimationBounds(_ toValue: Any?,
                                     delay: TimeInterval = 0,
                                     mass: CGFloat = 10.0,
    ...
    func sk_baseSpringAnimation(path: String?,
                                toValue: Any? = nil,
                                delay: TimeInterval = 0,
                                mass: CGFloat = 10.0,
                                stiffness: CGFloat = 5000,
...
public extension CALayer {
    func sk_baseAnimationGroup(animations: [CAAnimation]? = nil,
                               duration: TimeInterval = 2.0,
                               delay: TimeInterval = 0,
                               repeatCount: Float = 1,
                               removedOnCompletion: Bool = false,
...
public extension CALayer {
    func sk_addTransition(_ type: CATransitionType,
...
public extension CALayer {
    ...
    @discardableResult
    func sk_add2(_ superLayer: CALayer) -> Self {
    ...
    @discardableResult
    func sk_backgroundColor(_ color: UIColor) -> Self {
    ...
    @discardableResult
    func sk_borderWidth(_ width: CGFloat) -> Self {
        borderWidth = width
        return self
    }
    ...
    @discardableResult
    func sk_masksToBounds(_ masksToBounds: Bool = true) -> Self {
    ...
    @discardableResult
    func sk_corner(_ radius: CGFloat, corners: UIRectCorner = .allCorners) -> Self {
